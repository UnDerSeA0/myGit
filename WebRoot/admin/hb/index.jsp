...
<TBODY>
    ...
    <%
			List pagelist3=hk.getALLHB();
				if(!pagelist3.isEmpty()){
				for(int i=0;i<pagelist3.size();i++){
					List pagelist2 =(ArrayList)pagelist3.get(i);	
					int i1=hk.getSUMPRICE(pagelist2.get(0).toString());	
					int i2=hk.getSUMCPRICE(pagelist2.get(0).toString());	
					int i3=hk.getSUMMPRICE(pagelist2.get(0).toString()); 	
			%> 
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><%=pagelist2.get(14).toString() %></td>
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><%=Integer.parseInt(pagelist2.get(14).toString())-i1-i2-i3 %></td>
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>admin/hb/add.jsp?method=upHB&id=<%=pagelist2.get(0).toString()%>">修改</a></td>
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>HkServlet?method=delHB&id=<%=pagelist2.get(0).toString()%>">删除</a></td>
    </tr>
