       ...
       <TABLE class=dragTable  cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
         ...
         <TR>
          ...
          <TD align=left><input type=text name=price size=10> 张</TD>
        </TR>
        <TR>
          <TD width=50% align=right>儿童机票</TD>
          <TD align=left><input type=text name=cprice size=10> 张</TD>
        </TR>
        <TR>
          <TD width=50% align=right>会员机票</TD>
          <TD align=left><input type=text name=mprice size=10> 张</TD>
        </TR>
        <TR>
