                                                              ...
                                                              <TD vAlign=top align=middle bgColor=#ffffff height=257>
                                                                <TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
                                                                  <TBODY>
                                                                    <TR>
                                                                      <TD height=230>
                           <FORM id=form1 name=form1 action=/z_feijipiao/Login.shtml?method=PAGEUSERLOGIN method=post >
								...
								<IMG  height=52 src="/z_feijipiao/images/Key.gif" width=49>
									</TD>
                              ...
                              onkeyup="value=value.replace(/[\W]/g,'')">
                                  ...
                                  <TD width=81>
								  <LABEL>
								  <img src="/z_feijipiao/images/button.gif" border="0" onClick="checklogin()"> 
								  </LABEL>
								  </TD>
								  </TR>
								  <TR>
							  ...
							  <TR height=40>
								<TD class=buttomtxt align=middle colSpan=3 height=21>
								  ...
								  <A href="/z_feijipiao/reg.jsp">
								  <IMG src="/z_feijipiao/images/zhuce.gif" border=0>
								  </A>
								  </TD>
								  </TR>
								  </TBODY>
