...
<STYLE type=text/css>
.ycbt {
	BORDER-RIGHT: #fff 20px solid; BORDER-TOP: #fff 1px solid; PADDING-LEFT: 1.8em; BACKGROUND-COLOR: #EAF2EF; BORDER-LEFT: #fff 1px solid; PADDING-TOP: 7px; BORDER-BOTTOM: #fff 1px solid; HEIGHT: 20px
}
.xsbt {
	BORDER-RIGHT: #fff 20px solid; BORDER-TOP: #fff 1px solid; PADDING-LEFT: 1.8em; BACKGROUND-IMAGE: url(images/head1.gif); BORDER-LEFT: #fff 1px solid; PADDING-TOP: 7px; BORDER-BOTTOM: #fff 1px solid; HEIGHT: 20px
}
.xsnr {
	DISPLAY: block
}
...
//-->
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      <td  align="center">预定</td>
                    ...
                    <%
                    List AlljobList=hk.getALLHB("国际航线");
